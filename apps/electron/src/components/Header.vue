<template>
                ...
                <div class="profile" @click="toggleProfile">
                    ...
                    <div class="profile-menu" v-if="showProfile">
                        <ul>
                            ...
                            <li>
                                <a @click="openRegisterUrl(downloadUrl || 'https://github.com/oliver-xie666/sonic-music/releases')" style="position: relative;">
    ...
    <div v-if="isDisclaimerVisible" class="modal-overlay" @click="Disclaimer">
        <div class="modal-content" @click.stop>
            ...
            <div class="version-number">© Sonic Music <span v-if="appVersion">V{{ appVersion }} - {{ platform }}</span></div>
        </div>
    </div>
</template>
